...
We will simulate 3 scenarios to study the impact of COVID-19 pandemic on World welfare. The first one is to assume an increase of 10% on all international trade costs. The pandemic had countries rising tariff and non-tariff barriers to trade, blacklistted products were forbiden to both entry and leaving countries. The second scenario relates to lockdown imposition and its effects on productivities. **We keep the normalization done in productivities while decreasing all other values by 3%.**[^oecd] That way the USA is still the reference country, and other countries had lost relative productivity. Finally, our last scenario combines the previous two, trade costs have increased and at the same time productivities were reduced. Simulation results from these scenarios in comparison to the baseline are provided in the folowing tables.

[^oecd]: https://data.oecd.org/lprdty/labour-productivity-forecast.htm
